...
# Natural TTS and fast ASR tuning remain active without forcing a faster pace.
...
print("v6.6.1 manual-code, simple-UI, natural no-cut voice, prompt-rhythm, and fast-ASR checks: OK")
