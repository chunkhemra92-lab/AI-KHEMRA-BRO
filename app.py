...
with st.container(key="api_menu_container"):
    with st.popover("☰ Settings", help="Open private app settings and API keys"):
        st.markdown("### ⚙️ Settings")
        st.caption("Choose your basic options below, then tap Save. These settings are private to this browser.")
        ...
        with st.expander("▸ More workflow options", expanded=False):
            st.selectbox(
