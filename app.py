...
def admin_dashboard():
    ...
    if not admin_password:
        st.error("Owner Dashboard is disabled. Set ADMIN_PASSWORD in Streamlit Secrets before using it.")
...
st.caption("AI-KHEMRA-BRO v6.7.6 • VPS Persistent Storage Ready • Browser-Private Isolation • Mobile-first")
