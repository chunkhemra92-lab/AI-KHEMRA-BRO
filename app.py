...
def create_mp3(srt_text, progress_callback=None):
    ...
    with tempfile.TemporaryDirectory() as folder:
        ...
        # Master once after mixing. A slow, low-ratio final stage keeps one
        # character from suddenly becoming loud while retaining natural rises
        # and falls inside real speech. There is no per-word normalization.
        filters.append(
            ''.join(labels)
...
st.caption("AI-KHEMRA-BRO v6.4.9 • Multilingual → Khmer • 4 Voice Tags • Mobile-first")
