...
.st-key-settings_drawer{position:fixed!important;top:68px!important;left:12px!important;z-index:1000000!important;width:min(380px,calc(100vw - 38px))!important;height:calc(100dvh - 92px)!important;max-height:calc(100dvh - 92px)!important;box-sizing:border-box!important;margin:0!important;padding:20px 18px 34px!important;overflow-y:auto!important;overscroll-behavior:contain!important;background:#0c1424!important;border:1px solid #23d7f2!important;border-radius:22px!important;box-shadow:16px 12px 38px rgba(0,0,0,.52)!important;color:#f8fafc!important;scrollbar-width:thin;scrollbar-color:#38d9f5 #0c1424;transform-origin:left center;backface-visibility:hidden;will-change:transform,opacity,clip-path;animation:settings-page-open .58s cubic-bezier(.2,.78,.2,1) both}
@keyframes settings-page-open{0%{opacity:0;transform:perspective(1250px) rotateY(-78deg) translate3d(-18px,0,0);clip-path:inset(0 98% 0 0 round 22px);filter:brightness(.7)}28%{opacity:.92;transform:perspective(1250px) rotateY(-38deg) translate3d(-8px,0,0);clip-path:inset(0 52% 0 0 round 22px);filter:brightness(.86)}64%{opacity:1;transform:perspective(1250px) rotateY(7deg) translate3d(2px,0,0);clip-path:inset(0 0 0 0 round 22px);filter:brightness(1.04)}82%{transform:perspective(1250px) rotateY(-2deg) translate3d(0,0,0)}100%{opacity:1;transform:perspective(1250px) rotateY(0deg) translate3d(0,0,0);clip-path:inset(0 0 0 0 round 22px);filter:brightness(1)}}
.st-key-settings_drawer > div{animation:settings-page-content .42s cubic-bezier(.2,.78,.2,1) .16s both;transform-origin:left center}
@keyframes settings-page-content{from{opacity:0;transform:translate3d(18px,0,0) scale(.985)}to{opacity:1;transform:translate3d(0,0,0) scale(1)}}
