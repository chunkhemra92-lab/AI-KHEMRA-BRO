...
needed_assignments = {"PISITH", "SREYMOM", "VOICE_PROFILES", "FINAL_LEVELER_FILTER", "TAG_ALIASES"}
needed_functions = {
    "normalize_voice_tag", "normalize_dialogue", "prepare_tts_text", "synthesize",
    "run_async", "character_voice_filters", "voice_tone_filters", "create_single_voice_mp3",
}
nodes = []
...
print("Live Edge-TTS Khmer profile generation and polished Text → Speech: OK")
