...
with tempfile.TemporaryDirectory() as d:
    ...
    command = [
        ...
        '[1:a]highpass=f=180,treble=g=4:f=10000,pan=stereo|c0=c0|c1=c0,extrastereo=m=2.2,aecho=0.65:0.35:45|300|650|1100|1800|2600|3200:0.32|0.24|0.18|0.13|0.09|0.06|0.04,volume=-7dB[thought];'
